                ...
                Ok((bank_forks, ..)) => {
                    ...
                    if arg_matches.is_present("recalculate_capitalization") {
                        ...
                        if old_capitalization == bank.capitalization() {
                            eprintln!("Capitalization was identical: {}", Gema(old_capitalization));
                        }
                    }
                    ...
                    if arg_matches.is_present("warp_epoch") {
                        ...
                        println!(
                            ...
                            Gema(base_bank.capitalization()),
                            Gema(warped_bank.capitalization()),
                            Gema(warped_bank.capitalization() - base_bank.capitalization()),
                            interest_per_epoch,
                            interest_per_year,
                        );
                        ...
                        println!("Capitalization: {}", Gema(bank.capitalization()));
                    }
                }
                Err(err) => {
                    eprintln!("Failed to load ledger: {:?}", err);
