...
pub const CREATOR_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        carats: 5_000_000 * LAMPORTS_PER_GEMA,
    ...
    StakerInfo {
        ...
        carats: 1_205_602 * LAMPORTS_PER_GEMA,
    ...
    StakerInfo {
        ...
        carats: 3_655_292 * LAMPORTS_PER_GEMA,
    ...
    StakerInfo {
        ...
        carats: 103_519 * LAMPORTS_PER_GEMA,
    ...
    StakerInfo {
        ...
        carats: 3_880_295 * LAMPORTS_PER_GEMA,
...
pub const SERVICE_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        carats: 225_000 * LAMPORTS_PER_GEMA,
...
pub const FOUNDATION_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        carats: 57_500_000 * LAMPORTS_PER_GEMA,
...
pub const GRANTS_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        carats: 15_000_000 * LAMPORTS_PER_GEMA,
...
pub const COMMUNITY_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        carats: 30_301_032 * LAMPORTS_PER_GEMA,
    ...
    StakerInfo {
        ...
        carats: 153_333_633 * LAMPORTS_PER_GEMA + 41 * LAMPORTS_PER_GEMA / 100,
...
pub fn add_genesis_accounts(genesis_config: &mut GenesisConfig, mut issued_carats: u64) {
    ...
    create_and_add_stakes(
        ...
        &StakerInfo {
            ...
            carats: (500_000_000 * LAMPORTS_PER_GEMA).saturating_sub(issued_carats),
...
mod tests {
    ...
    fn test_add_genesis_accounts() {
        ...
        assert_eq!(500_000_000 * LAMPORTS_PER_GEMA, carats);
    }
}
