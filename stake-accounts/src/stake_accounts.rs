...
pub(crate) fn rebase_stake_accounts(
    ...
    balances
        .iter()
        .enumerate()
        .filter_map(|(i, (stake_account_address, carats))| {
...
mod tests {
    ...
    fn create_bank(carats: u64) -> (Bank, Keypair, u64) {
    ...
    fn create_account<C: SyncClient>(
        ...
        client
            .transfer_and_confirm(carats, funding_keypair, &fee_payer_keypair.pubkey())
            .unwrap();
        fee_payer_keypair
    }
    ...
    fn test_new_derived_stake_account() {
        ...
        assert_eq!(account.carats(), carats);
