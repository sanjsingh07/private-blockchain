...
impl<'a> fmt::Debug for AccountInfo<'a> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        write!(
            f,
            "AccountInfo {{ key: {} owner: {} is_signer: {} is_writable: {} executable: {} rent_epoch: {} carats: {} data.len: {} {} }}",
            self.key,
            self.owner,
            self.is_signer,
            self.is_writable,
...
impl<'a> AccountInfo<'a> {
    ...
    pub fn try_borrow_carats(&self) -> Result<Ref<&mut u64>, ProgramError> {
        self.carats
            .try_borrow()
            .map_err(|_| ProgramError::AccountBorrowFailed)
    }

    pub fn try_borrow_mut_carats(&self) -> Result<RefMut<&'a mut u64>, ProgramError> {
        self.carats
            .try_borrow_mut()
            .map_err(|_| ProgramError::AccountBorrowFailed)
    }
    ...
    pub fn new(
        ...
        Self {
            ...
            is_signer,
            is_writable,
            carats: Rc::new(RefCell::new(carats)),
...
impl<'a, T: Account> IntoAccountInfo<'a> for (&'a Pubkey, &'a mut T) {
    fn into_account_info(self) -> AccountInfo<'a> {
        ...
        let (carats, data, owner, executable, rent_epoch) = account.get();
        AccountInfo::new(
            key, false, false, carats, data, owner, executable, rent_epoch,
        )
    }
}
...
impl<'a, T: Account> IntoAccountInfo<'a> for (&'a Pubkey, bool, &'a mut T) {
    fn into_account_info(self) -> AccountInfo<'a> {
        ...
        let (carats, data, owner, executable, rent_epoch) = account.get();
        AccountInfo::new(
            key, is_signer, false, carats, data, owner, executable, rent_epoch,
        )
    }
}
