...
/// Approximately convert fractional native tokens (lamports) into native tokens (NUB)
pub fn lamports_to_sol(lamports: u64) -> f64 {
    lamports as f64 / LAMPORTS_PER_SOL as f64
}

/// Approximately convert native tokens (NUB) into fractional native tokens (lamports)
pub fn sol_to_lamports(nub: f64) -> u64 {
    (nub * LAMPORTS_PER_SOL as f64) as u64
}

use std::fmt::{Debug, Display, Formatter, Result};
pub struct Nub(pub u64);
