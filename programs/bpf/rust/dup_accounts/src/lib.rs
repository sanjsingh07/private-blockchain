...
fn process_instruction(
    ...
    match instruction_data[0] {
        ...
        4 => {
            msg!("modify account (1,2) carats");
            **accounts[1].carats.borrow_mut() -= 1;
            **accounts[2].carats.borrow_mut() += 1;
        }
        5 => {
            msg!("modify account (1,3) carats");
            **accounts[1].carats.borrow_mut() -= 2;
            **accounts[3].carats.borrow_mut() += 2;
        }
        6 => {
            msg!("modify account (1,2,3) carats");
            **accounts[1].carats.borrow_mut() -= 3;
            **accounts[2].carats.borrow_mut() += 1;
            **accounts[3].carats.borrow_mut() += 2;
        }
        7 => {
