...
fn process_instruction(
    ...
    match instruction_data[0] {
        VERIFY_TRANSLATIONS => {
            ...
            assert_eq!(accounts[ARGUMENT_INDEX].carats(), 42);
            ...
            assert_eq!(accounts[INVOKED_ARGUMENT_INDEX].carats(), 10);
            ...
            assert_eq!(
                accounts[INVOKED_PROGRAM_INDEX].carats,
        ...
        NESTED_INVOKE => {
            ...
            **accounts[INVOKED_ARGUMENT_INDEX].carats.borrow_mut() -= 1;
